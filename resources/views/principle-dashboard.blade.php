				...
				<div class="card-body">
					<div class="db-widgets d-flex justify-content-between align-items-center">
						<div class="db-info">
							...
							<h3>{{App\Models\User::where(['type'=>'teacher','school'=>Auth::user()->school])->count()}}</h3>
						</div>	
						<div class="db-icon">
			...
			<div class="card bg-comman w-100">
				<div class="card-body">
					<div class="db-widgets d-flex justify-content-between align-items-center">
						...
						<div class="db-icon">
							<img  src="{{ URL::asset('/assets/img/icons/teacher-icon-03.svg')}}"  alt="Dashboard Icon">
						</div>
					</div>
				</div>
			</div>
